- dashboard: escal_total_test
  ...
  layout: newspaper
  elements:
  - name: ESCAL P1/P2/P3 Issue Summary Report by Top Platform
    title: ESCAL P1/P2/P3 Issue Summary Report by Top Platform
    model: jira.dev
    explore: escal_2_total
    type: table
    fields:
    - escal_2_total.component_priority
    - escal_2_total.count
    - escal_2_total.category
    - escal_2_total.count_created_yesterday
    - escal_2_total.count_resolved_yesterday
    pivots:
    - escal_2_total.category
    filters:
