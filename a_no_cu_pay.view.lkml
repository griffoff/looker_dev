view: a_no_cu_pay {
   derived_table: {
    sql: with
      ...
      , case when pp."source" like  'unlimited' then 'Paid via CU (Unlimited)' else case when pp."source" like 'gateway' then 'Paid via CU (Gateway)' else case when pp."source" is null then 'Paid via CU (K12)' end end  end as status_2
