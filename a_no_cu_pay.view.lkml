   ...
   derived_table: {
    sql: with
      enroll as (
            ...
            from prod.UNLIMITED.RAW_OLR_ENROLLMENT sub left outer join prod.unlimited.EXCLUDED_USERS exc on sub.user_sso_guid = exc.user_sso_guid
